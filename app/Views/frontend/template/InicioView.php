		...
		<div class="pl-4 pr-0 h-100 tofront">
			<div class="row justify-content-between">
				<div class="col-md-6 pt-6 pb-6 align-self-center">
					<h1 class="secondfont mb-3 font-weight-bold">¿Estás buscando aserorías digitales? ¡Entonces esta es la oportunidad perfecta para ti!</h1>
					<p class="mb-3">
						Te invito a unirte a nuestras asesorías digitales, donde aprenderás todo sobre tecnología, desde cómo utilizar herramientas básicas hasta dominar programas avanzados. Nuestro equipo de expertos estará encantado de guiarte en este emocionante viaje hacia el mundo digital. <br><br>
No te pierdas esta oportunidad de adquirir nuevas habilidades que te abrirán las puertas a nuevas oportunidades profesionales y personales. ¡Inscríbete ahora y comienza tu transformación digital!
					</p>
					<a href="#" class="btn btn-dark">Solicitar Asesoría</a>
				</div>
				<div class="col-md-6 d-none d-md-block pr-0" style="background-size:cover;background-image:url(<?= base_url('assets/frontend/img/demo/home.png'); ?>">	</div>
			</div>
		</div>
	</div>
</div>
