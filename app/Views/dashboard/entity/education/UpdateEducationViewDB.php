<main>
  ...
  <div class="form-group">
    ...
    <div>
      <select id="i_educativa" name="i_educativa" aria-describedby="i_educativaHelpBlock" required="required" class="custom-select" value="<?= $formacion['institucion']?>>
    ...
    <div class="form-group">
        ...
        <div>
        <select id="t_formacion" name="t_formacion" aria-describedby="t_formacionHelpBlock" required="required" class="custom-select" value="<?= $formacion['tipo_programa']?>>
            <option value="Seleccione">Seleccione...</option>
    ...
    <label for="c_formacion">Categoría de Formación</label> 
        <div>
        <select id="c_formacion" name="c_formacion" class="custom-select" aria-describedby="c_formacionHelpBlock" required="required" value="<?= $formacion['categoria_programa']?>>
            <option value="Seleccione">Seleccione...</option>
