<main>
  ...
  <div class="form-group">
    ...
    <option value="none" value="<?= $formacion['institucion']?>"><?= $formacion['institucion']?></option> 
    ...
    <div class="form-group">
        ...
        <option value="none" value="<?= $formacion['tipo_programa']?>"><?= $formacion['tipo_programa']?></option> 
        <option value="SELECCIONE">SELECCIONE</option>
    ...
    <label for="c_formacion">Categoría de Formación</label> 
        ...
        <option value="none" value="<?= $formacion['categoria_programa']?>"><?= $formacion['categoria_programa']?></option> 
        <option value="SELECCIONE">SELECCIONE</option>
